...
public class SoldByPieceTest {
    ...
    public void firstScenario() {
        ...
        transaction = storeCheckoutService.scanItem(transaction, products.get("3"), new BigDecimal("3"));
        transaction = storeCheckoutService.scanItem(transaction, products.get("2"), new BigDecimal("5"));
